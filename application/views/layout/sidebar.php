...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('superadmin')) {
            ?>
                                <li class="<?php echo set_Submenu('System Settings/updater'); ?>"><a href="<?php echo base_url(); ?>admin/updater"><i class="fa fa-angle-double-right"></i> <?php echo "Help & Support" ?></a></li>
                        <?php
}
