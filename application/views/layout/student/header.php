 ...
 ?>
      ...
      <a data-toggle="modal" data-target="#user_sessionModal"><span><?php echo $this->lang->line('current_session') . ": " . $this->setting_model->getCurrentSessionName(); ?></span><i class="fa fa-pencil pull-right"></i></a>
                    ...
                    <ul class="sidebar-menu verttop38" id="sibe-box">
						...
						<?php
                       if($this->module_lib->hasModule('online_course') && $this->studentmodule_lib->hasActive('online_course')
                        //&& $this->auth->addonchk('ssoclc',false)
                        ){                    
                       ?>								
						...
						<?php } ?>  
                               ...
                               <?php
                       if($this->module_lib->hasModule('zoom_live_classes') && $this->studentmodule_lib->hasActive('live_classes') 
                      // && $this->auth->addonchk('sszlc',false)
                       ){                     
                            ?>
...
<?php 
 ...
 <?php
                         if($this->module_lib->hasModule('gmeet_live_classes') && $this->studentmodule_lib->hasActive('gmeet_live_classes') 
                         //&& $this->auth->addonchk('ssglc',false)
                         ){
